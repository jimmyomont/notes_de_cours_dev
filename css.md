...
- margin-top: permet de spécifier la marge supérieure de l'élément.
- margin-right: permet de spécifier la marge droite de l'élément.
- margin-bottom: permet de spécifier la marge inférieure de l'élément.
...
- padding-right: permet de caractéristiques le rembourrage droit de l'élément.
...
### Flexbox :
- isplay: flex : permet de créer un conteneur de boîtes flexibles.
